...
#include "persistent_concurrent_arena.h"
#include <thread>
...
__thread uint32_t PersistentConcurrentArena::tls_cpuid = 0;
#endif

PersistentConcurrentArena::PersistentConcurrentArena(size_t block_size, size_t huge_page_size)
...
PersistentConcurrentArena::Shard* PersistentConcurrentArena::Repick() {
